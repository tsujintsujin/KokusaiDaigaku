...
<div class="d-flex col-md-2 col-lg-3 flex-column flex-shrink-0 vh-100  gradient-custom" id="sidebar"
    ...
    <div id="navToggle2" class="text-center bg-secondary-color pt-1 rounded-circle">
        <a role="button" href="{{ route('teacher') }}" id="navToggleText2" class="text-dark pt-2 btn rounded-circle btnToggle">
    ...
    <div id="navToggle3" class="text-center bg-secondary-color pt-1 rounded-circle">
        <a role="button" href="{{ route('gradeinput') }}" id="navToggleText3" class="text-dark pt-2 btn rounded-circle btnToggle">
    ...
    <div id="navToggle4" class="text-center bg-secondary-color pt-1 rounded-circle">
        <a role="button" href="{{ route('teacherchangepassword') }}" id="navToggleText4" class="text-dark pt-2 btn rounded-circle btnToggle">
