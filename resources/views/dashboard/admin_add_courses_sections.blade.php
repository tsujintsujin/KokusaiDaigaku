                                                        ...
                                                        <div class="row mt-4">
                                                            <div class="col-4">
                                                                <div class="col">
                                                                    <div class="dropdown">
                                                                        ...
                                                                        <a class="btn btn-primary dropdown-toggle w-100 text-start mt-1"
                                                                            href="#" role="button"
                                                            ...
                                                            <div class="col">
                                                                <div class="form-outline mb-4 bg-white rounded p-1 pt-2">
                                                                    ...
                                                                    <label class="form-label" for="form1Example1">Section
                                                                        Name</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row my-4">
                                                        <div class="col-2">
                                                            ...
                                                            <div class="dropdown">
                                                                ...
                                                                <a class="btn btn-primary dropdown-toggle w-100 text-start"
                                                        ...
                                                        <div class="col-2">
                                                            <div class="col">
                                                                <div
                                                                    class="form-outline mb-4 bg-white rounded p-1 pt-2 mt-4">
                                                                    <input type="text" id="form1Example1"
                                                                        class="form-control" name="subject_code" />
                                                                    <label class="form-label" for="form1Example1">Subject
                                                                        Code</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col">
                                                            <div class="form-outline mb-4 bg-white rounded ">
                                                                ...
                                                                <label class="form-label"
                                                                    for="form4Example3">Description</label>
                                                            </div>
                                                        </div>
                                                    </div>
