...
<div class="container my-5 py-5">
    <div class="row">
        <div class="col justify-content">
            <h1 class="fw-bold color-title" data-aos="fade-right" data-aos-duration="2000">SCHOLARSHIPS<span><img class="yellow-arrow ms-3 mb-2" src="{{ asset('image/right_arrow.png') }}" alt=""></span></h1>
            <h5 class="fw-bold color-title" data-aos="fade-right" data-aos-delay="200" data-aos-duration="2000">ACADEMIC SCHOLARSHIPS AND GRANT-IN-AID</h5>
            <p data-aos="fade-right" data-aos-delay="200" data-aos-duration="2000">The College acknowledges top-performing students
        ...
        <div class="col mt-5" data-aos="fade-left" data-aos-delay="400" data-aos-duration="2000">
...
<div class="container">
    <div class="text-end">
        <h1 class="fw-bold color-title" data-aos="fade-left" data-aos-duration="2000"><span><img class="yellow-arrow me-3 mb-2" src="{{ asset('image/left_arrow.png') }}" alt=""></span>LINKAGES</h1>
        <h5 class="fw-bold color-title" data-aos="fade-left" data-aos-duration="2000">Partner Institutions of MKD in Japan</h5>
    </div>
    <div class="mb-5">
        <p class="mt-5" data-aos="fade-right" data-aos-duration="2000">The Academic Partnership Agreements with the following Japanese colleges and corporations were forged to cooperate in the spirit of equality and mutual benefit, deepen friendship and promote education and academic exchanges between students, faculty members, and administrative staff.</p>
        <ul data-aos="fade-right" data-aos-delay="600" data-aos-duration="2000">
    ...
    <div class="mb-5">
        <h3 class="color-title" data-aos="fade-right" data-aos-duration="2000">BE ONE OF THEM!<span><img class="yellow-arrow ms-3 mb-2" src="{{ asset('image/right_arrow.png') }}" alt=""></span></h3>
        <p data-aos="fade-right" data-aos-duration="2000">The College supports different educational tour opportunities outside the country. Selected students benefit from the beauty of cultural exchanges.</p>
        <p data-aos="fade-right" data-aos-duration="2000">The following are the study tour programs enjoyed by the MKDians:</p>
