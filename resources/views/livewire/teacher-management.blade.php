            ...
            <div class="row dashboardContainer ps-4 pb-4 pe-4">
                ...
                <div class="row mt-4">
                    <div class="col">
                        ...
                        <div class="form-outline bg-white rounded p-1">
                            <input type="text" id="" class="form-control"  wire:focus="teacherLastNameErrorClear" wire:model="teacherLastName" />
                        </div>
                    </div>
                    <div class="col">
                        ...
                        <div class="form-outline bg-white rounded p-1">
                            <input type="text" id="" class="form-control"  wire:focus="teacherFirstNameErrorClear" wire:model="teacherFirstName" />
                        </div>
                    </div>
                    <div class="col">
                ...
                <div class="row">
                    <div class="col-3 pt-2">
                        ...
                        <div class="form-check form-check-inline">
                            <input  wire:focus="teacherGenderErrorClear" wire:model="teacherGender" class="form-check-input" type="radio" id="inlineRadio1"
                                value="male" />
                            <label class="form-check-label" for="inlineRadio1">Male</label>
                        </div>

                        <div class="form-check form-check-inline">
                            <input  wire:focus="teacherGenderErrorClear" wire:model="teacherGender" class="form-check-input" type="radio" id="inlineRadio2"
                                value="female" />
                    ...
                    <div class="col-4">
                        ...
                        <div class="form-outline bg-white rounded p-1">
                            <input  wire:focus="teacherNationalityErrorClear" wire:model="teacherNationality" type="text" id="" class="form-control" />
                    ...
                    <div class="col">
                        ...
                        <div class="form-outline bg-white rounded p-1">
                            <input  wire:focus="teacherBirthdateErrorClear" wire:model="teacherBirthdate" type="date" id=""
                                class="form-control" />
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-3">
                        ...
                        <div class="form-outline bg-white rounded p-1">
                            <input type="email" id="" class="form-control"  wire:focus="teacherEmailErrorClear" wire:model="teacherEmail" />
                        </div>
                    </div>
                    <div class="col">
                        ...
                        <div class="form-outline bg-white rounded p-1">
                            <input type="text" id="" class="form-control"  wire:focus="teacherAddressErrorClear" wire:model="teacherAddress" />
                        </div>
                    </div>
                ...
                <div class="" id="accord">
                    ...
                    <div class="row">
                        <div class="col-3 pt-2">
                            ...
                            <br>
                            <div class="form-check form-check-inline">
                                <input  wire:focus="contactGenderErrorClear" wire:model="contactGender" class="form-check-input" type="radio"
                        ...
                        <div class="col-4">
                            ...
                            <div class="form-outline bg-white rounded p-1">
                                <input  wire:focus="contactNationalityErrorClear" wire:model="contactNationality" type="text" id=""
                                    class="form-control" />
            ...
            <div class="row dashboardContainer ps-4 pb-4">
                <div class="row mt-4">
                    <div class="col-3">
                        <div class="dropdown">
                            ...
                            <select wire:click="clearErrors" wire:model="selectedTeacher"class="form-select p-2"
                                aria-label="Default select example">
                ...
                <div class="row">
                    <div class="col-3 pt-2">
                        ...
                        <br>
                        <div class="form-check form-check-inline">
                            <input  wire:focus="teacherGenderErrorClear" wire:model="teacherGender" class="form-check-input" type="radio"
                    ...
                    <div class="col-4">
                        ...
                        <div class="form-outline bg-white rounded p-1">
                            <input  wire:focus="teacherNationalityErrorClear" wire:model="teacherNationality" type="text" id=""
                                class="form-control" />
