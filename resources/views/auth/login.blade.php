                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="row mb-3 mt-5 pt-5 d-flex justify-content-center">
                                <img src="{{ asset('image/logo.png') }}" class="rounded loginLogo position-absolute"
                                    alt="Mindanao Kokusai Daigaku Logo"
                                    style="width:200px !important;
                                    top:-100px;">
                                <div class="col-md-8">
                                    <input placeholder="{{ __('ID') }}" id="email" type="email"
                            ...
                            <div class="row mb-0">
                                <div class="col d-flex justify-content-center mt-3">
                                    @if (Route::has('password.request'))
                                        <a class="btn btn-link text-sm fw-bold text-decoration-none text-muted"
