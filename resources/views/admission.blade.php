...
<div class="container mt-5 mb-5">
    ...
    <div class="row">
        ...
        <div class="col-lg-6" data-aos="zoom-in" data-aos-duration="2000" data-aos-delay="800">
    ...
    <div class="mt-5 mb-5" data-aos="fade-right" data-aos-delay="200" data-aos-duration="2000">
    ...
    <div class="mb-5" data-aos="fade-right" data-aos-delay="500" data-aos-duration="2000">
    ...
    <div class="admission mb-5 container-fluid p-md-5 p-2 py-5"
        ...
        <div class="row d-flex justify-content-end  align-content-center h-100">
            <div class="admission-text col-md-8 col-lg-4 text-end">
                <h1 class="fw-bold color-title"data-aos="fade-right" data-aos-duration="1500"><span><img class="yellow-arrow me-3 mb-2"
                            src="{{ asset('image/left_arrow.png') }}" alt=""></span>PRE-ENROLL</h1>
                <hr>
                <h5 data-aos="fade-right" data-aos-delay="100"  data-aos-duration="1500">Please visit the MKD Facebook page for additional info on
                    the Online Enrollment for face-to-face schedules.</h5>
                <h5 data-aos="fade-right" data-aos-delay="200"  data-aos-duration="1500">For an advanced enrollment, you may click on the
    ...
    <div class="container mb-5" data-aos="fade-right" data-aos-duration="1500">
