...
<body>
    ...
    <header class="container mt-4">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            ...
            <div class="col-md-10">
                <h1 class="ps-4"><span style="color:#F6C400;">M</span>indanao <span style="color:#F6C400;">K</span>okusai <span style="color:#F6C400;">D</span>aigaku</h1>
...
@yield('content')
   ...
   <!-- Footer -->
   <footer class="text-center text-white p-4" style="background-color:#393280;">
